...
void main() {
  runApp(const Adoption4());
}

class Adoption4 extends StatelessWidget {
  const Adoption4({super.key});
  ...
  Widget _buildActionButtons() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _buildInfoTile(icon: Icons.pets, label: 'Breed', value: 'Persian'),
...
Widget _buildAdoptButton() {
  return Container(
    ...
    child: ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: const Color.fromARGB(255, 186, 163, 95), // Gold color
        foregroundColor: Colors.white,
        padding: const EdgeInsets.symmetric(vertical: 16),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
        elevation: 0,
